...
{
double ST_array[]={2600, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 7000};//
...
double xsec_theory_array[] = {array1, array2, array3, array4, array5, array6, array7, array8, array9};
...
ST_string=="3000" ||
ST_string=="3500" ||
ST_string=="4000" || ST_string=="4500" || ST_string=="5000" || ST_string=="5500" || ST_string=="6000" || ST_string=="7000")
...
tdrStyle->SetTitleYOffset(1.6);
  ...
  g_xsec->SetMaximum(2000.0); g_xsec->SetMinimum(0.1);
  g_xsec->Draw("AL");
  ...
  c_xsec->SaveAs("c_xsec_ModelIndependent_ST_Mul4.png");
  c_xsec->SaveAs("c_xsec_ModelIndependent_ST_Mul4.pdf");
