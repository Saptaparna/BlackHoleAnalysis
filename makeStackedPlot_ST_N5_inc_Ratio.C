...
void makeStackedPlot_ST_N5_inc_Ratio(){
...
*/
  ...
  THStack hs("hs","ST_N5_inc [GeV]");

  TFile* file0 = TFile::Open("output_QCD_HT_100_200.root");
  TH1F *h0 = (TH1F*)file0->Get("AllST/ST_N5_inc");
  h0->Sumw2();
  h0->Rebin(2);
  ...
  TH1F *h1 = (TH1F*)file1->Get("AllST/ST_N5_inc");
  h1->Sumw2();
  h1->Rebin(2);
  ...
  TH1F *h2 = (TH1F*)file2->Get("AllST/ST_N5_inc");
  h2->Sumw2();
  h2->Rebin(2);
  ...
  TH1F *h3 = (TH1F*)file3->Get("AllST/ST_N5_inc");
  h3->Sumw2();
  h3->Rebin(2);
  ...
  TH1F *h4 = (TH1F*)file4->Get("AllST/ST_N5_inc");
  h4->Sumw2();
  h4->Rebin(2);
  ...
  TH1F *h5 = (TH1F*)file5->Get("AllST/ST_N5_inc");
  h5->Sumw2();
  h5->Rebin(2);
  ...
  TH1F *h6 = (TH1F*)file6->Get("AllST/ST_N5_inc");
  h6->Sumw2();
  h6->Rebin(2);
  ...
  TH1F *h7 = (TH1F*)file7->Get("AllST/ST_N5_inc");
  h7->Sumw2();
  h7->Rebin(2);
  ...
  TH1F *h8 = (TH1F*)data->Get("AllST/ST_N5_inc");
  h8->Sumw2();
  h8->Rebin(2);
  ...
  h_ratio->SetTitle("; #bf{ST (all objects) with N >= 5 [GeV]}");
  ...
  c1.SaveAs("h_Stacked_ST_N5_inc.pdf");
  c1.SaveAs("h_Stacked_ST_N5_inc.png");
