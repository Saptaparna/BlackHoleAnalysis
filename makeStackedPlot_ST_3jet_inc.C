...
void makeStackedPlot_ST_3jet_inc(){
  ...
  THStack hs("hs","ST_3jet_inc [GeV]");

  TFile* file0 = TFile::Open("output_QCD_HT_100_200.root");
  TH1F *h0 = (TH1F*)file0->Get("JetST/ST_3jet_inc");
  h0->Rebin(1);
  h0->GetXaxis()->SetRangeUser(800, 5500);
  ...
  TH1F *h1 = (TH1F*)file1->Get("JetST/ST_3jet_inc");
  h1->Rebin(1);
  h1->GetXaxis()->SetRangeUser(800, 5500);
  ...
  TH1F *h2 = (TH1F*)file2->Get("JetST/ST_3jet_inc");
  h2->Rebin(1);
  h2->GetXaxis()->SetRangeUser(800, 5500);
  ...
  TH1F *h3 = (TH1F*)file3->Get("JetST/ST_3jet_inc");
  h3->Rebin(1);
  h3->GetXaxis()->SetRangeUser(800, 5500);
  ...
  TH1F *h4 = (TH1F*)file4->Get("JetST/ST_3jet_inc");
  h4->Rebin(1);
  h4->GetXaxis()->SetRangeUser(800, 5500);
  ...
  TH1F *h5 = (TH1F*)file5->Get("JetST/ST_3jet_inc");
  h5->Rebin(1);
  h5->GetXaxis()->SetRangeUser(800, 5500);
  ...
  TH1F *h6 = (TH1F*)file6->Get("JetST/ST_3jet_inc");
  h6->Rebin(1);
  h6->GetXaxis()->SetRangeUser(800, 5500);
  ...
  TH1F *h7 = (TH1F*)file7->Get("JetST/ST_3jet_inc");
  h7->Rebin(1);
  h7->GetXaxis()->SetRangeUser(800, 5500);
  ...
  hs.SetMinimum(0.1);
  hs.GetXaxis()->SetRangeUser(800, 5500);
  hs.GetXaxis()->SetTitle("ST with nJets >= 3 [GeV]");
  ...
  TH1F *h8 = (TH1F*)data->Get("JetST/ST_3jet_inc");
  h8->Rebin(1);
  h8->SetLineColor(kBlack);
  h8->SetMarkerStyle(20);
  h8->SetMarkerSize(1.0);
  h8->GetXaxis()->SetRangeUser(800, 5500);
  h8->Draw("SAME E");
...
h_ratio->SetTitle("; #bf{ST_3jet_inc [GeV]}");
...
*/
c1.SaveAs("h_Stacked_ST_3jet_inc.pdf");
c1.SaveAs("h_Stacked_ST_3jet_inc.png");
