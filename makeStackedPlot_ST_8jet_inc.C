...
void makeStackedPlot_ST_8jet_inc(){
  ...
  THStack hs("hs","ST_8jet_inc [GeV]");

  TFile* file0 = TFile::Open("output_QCD_HT_100_200.root");
  TH1F *h0 = (TH1F*)file0->Get("JetST/ST_8jet_inc");
  h0->Rebin(1);
  ...
  TH1F *h1 = (TH1F*)file1->Get("JetST/ST_8jet_inc");
  h1->Rebin(1);
  ...
  TH1F *h2 = (TH1F*)file2->Get("JetST/ST_8jet_inc");
  h2->Rebin(1);
  ...
  TH1F *h3 = (TH1F*)file3->Get("JetST/ST_8jet_inc");
  h3->Rebin(1);
  ...
  TH1F *h4 = (TH1F*)file4->Get("JetST/ST_8jet_inc");
  h4->Rebin(1);
  ...
  TH1F *h5 = (TH1F*)file5->Get("JetST/ST_8jet_inc");
  h5->Rebin(1);
  ...
  TH1F *h6 = (TH1F*)file6->Get("JetST/ST_8jet_inc");
  h6->Rebin(1);
  ...
  TH1F *h7 = (TH1F*)file7->Get("JetST/ST_8jet_inc");
  h7->Rebin(1);
  ...
  hs.GetXaxis()->SetTitle("ST with nJets >= 8 [GeV]");
  ...
  TH1F *h8 = (TH1F*)data->Get("JetST/ST_8jet_inc");
  h8->Rebin(1);
...
h_ratio->SetTitle("; #bf{ST_8jet_inc [GeV]}");
...
*/
c1.SaveAs("h_Stacked_ST_8jet_inc.pdf");
c1.SaveAs("h_Stacked_ST_8jet_inc.png");
