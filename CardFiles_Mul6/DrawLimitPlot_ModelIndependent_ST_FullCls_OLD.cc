...
{
double ST_array[]={2600, 3000, 3500, 4000, 4500, 5000, 5500, 5800};//
...
double xsec_theory_array[] = {array1, array2, array3, array4, array5, array6, array7, array8};
...
if (ST_string=="2600" || ST_string=="3000" || ST_string=="3500" || ST_string=="4000" || ST_string=="4500" || ST_string=="5000" || ST_string=="5500" || ST_string=="5800")
...
g_xsec->SetTitle("; ST_{min} [GeV]; #sigma(ST > ST_{min}) X A(fb)");
...
g_xsec->SetMaximum(1000.0); g_xsec->SetMinimum(0.1);
g_xsec->Draw("AL");
...
leg->SetHeader("Multiplicity >= 6");
  ...
  c_xsec->SaveAs("c_xsec_ModelIndependent_ST_Mul6.png");
  c_xsec->SaveAs("c_xsec_ModelIndependent_ST_Mul6.pdf");
