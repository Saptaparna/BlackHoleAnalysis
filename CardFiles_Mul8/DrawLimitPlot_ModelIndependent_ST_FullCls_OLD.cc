...
void DrawLimitPlot_ModelIndependent_ST_FullCls()
{
  ...
  g_xsec->SetMaximum(500.0); g_xsec->SetMinimum(0.1);
  g_xsec->Draw("AL");
  ...
  c_xsec->SaveAs("c_xsec_ModelIndependent_ST_Mul8.png");
  c_xsec->SaveAs("c_xsec_ModelIndependent_ST_Mul8.pdf");
