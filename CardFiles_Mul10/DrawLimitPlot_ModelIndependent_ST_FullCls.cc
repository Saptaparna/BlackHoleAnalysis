...
{
  double ST_array[]={3000, 3500, 4000, 4500, 5000, 5500, 5800};//
  ...
  for (unsigned int i_ST=0; i_ST<ST.size(); ++i_ST)
  {
    ...
    if (ST_string=="3000" || ST_string=="3500" || ST_string=="4000" || ST_string=="4500" || ST_string=="5000" || ST_string=="5500" || ST_string=="5800")    
  ...
  g_xsec->SetTitle("; ST^{min} [GeV]; 95\% #sigma(ST > ST_{min}) X A(fb)");
  ...
  g_xsec->SetMaximum(500.0); g_xsec->SetMinimum(0.05);
  g_xsec->Draw("AL");
  ...
  c_xsec->SaveAs("c_xsec_ModelIndependent_ST_Mul10.png");
  c_xsec->SaveAs("c_xsec_ModelIndependent_ST_Mul10.pdf");
